    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div class="bg-white p-6 rounded-lg shadow border border-green-500">
                    <h3 class="font-bold text-lg mb-2">User Experience</h3>
                    <div class="text-3xl font-bold {{ $uxScores <= 2 ? 'text-green-600' : ($uxScores <= 3.5 ? 'text-yellow-600' : 'text-red-600') }}">
                        {{ number_format($uxScores, 2) }}/5
                    </div>
                </div>
                <div class="bg-white p-6 rounded-lg shadow border border-green-500">
                    <h3 class="font-bold text-lg mb-2">Content Quality</h3>
                    <div class="text-3xl font-bold {{ $contentScores <= 2 ? 'text-green-600' : ($contentScores <= 3.5 ? 'text-yellow-600' : 'text-red-600') }}">
                        {{ number_format($contentScores, 2) }}/5
                    </div>
                </div>
                <div class="bg-white p-6 rounded-lg shadow border border-green-500">
                    <h3 class="font-bold text-lg mb-2">Technical Performance</h3>
                    <div class="text-3xl font-bold {{ $technicalScores <= 2 ? 'text-green-600' : ($technicalScores <= 3.5 ? 'text-yellow-600' : 'text-red-600') }}">
